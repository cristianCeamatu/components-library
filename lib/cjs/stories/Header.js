...
var SBButton_1 = require("./SBButton");
require("./header.css");
var Header = function (_a) {
    ...
    return (react_1.default.createElement("header", null,
        react_1.default.createElement("div", { className: "wrapper" },
            ...
            react_1.default.createElement("div", null, user ? (react_1.default.createElement(SBButton_1.SBButton, { size: "small", onClick: onLogout, label: "Log out" })) : (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement(SBButton_1.SBButton, { size: "small", onClick: onLogin, label: "Log in" }),
                react_1.default.createElement(SBButton_1.SBButton, { primary: true, size: "small", onClick: onCreateAccount, label: "Sign up" })))))));
};

...
export var Header = function (_a) {
    ...
    return (React.createElement("header", null,
        React.createElement("div", { className: "wrapper" },
            ...
            React.createElement("div", null, user ? (React.createElement(SBButton, { size: "small", onClick: onLogout, label: "Log out" })) : (React.createElement(React.Fragment, null,
                React.createElement(SBButton, { size: "small", onClick: onLogin, label: "Log in" }),
                React.createElement(SBButton, { primary: true, size: "small", onClick: onCreateAccount, label: "Sign up" })))))));
};
